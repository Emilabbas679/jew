                    ...
                    <div class="col-md-4">
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-footer flex-wrap pt-0">
                                <a href="{{route('roles.edit', $item->id)}}" class="btn btn-light btn-active-primary my-1 me-2">Edit Role</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
                        ...
                        <div class="card h-md-100">
                            ...
                            <div class="card-body d-flex flex-center">
                                ...
                                <a href="{{route('roles.create')}}" class="btn btn-clear d-flex flex-column flex-center" >
                                    <img src="{{asset('/back/assets/media/illustrations/sketchy-1/4.png')}}" alt="" class="mw-100 mh-150px mb-7" />
