    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                ...
                <form enctype="multipart/form-data" onsubmit="getAbouts()"  id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="apps/ecommerce/catalog/categories.html" method="POST" action="{{route('blogs.update', $blog->id)}}">
                    @csrf
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                @php
                                    $image = $blog->image ? '/storage/'.$blog->image : '/back/assets/media/svg/files/blank-image.svg';
                                @endphp
